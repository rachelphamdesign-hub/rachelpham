...
/** Figma 260:20266 — Refined hero (badge, title, tagline, video mockup, Role / Team / Timeline / Platform). */
export function IdeasToImpactRefinedHero({ project }: { project: ProjectMeta }) {
  const videoSrc = project.heroVideo ?? "/media/ideas-to-impact-hero.mp4";
  ...
  return (
    <div className="mx-auto max-w-[980px] px-6">
      ...
      <div className="mx-auto flex max-w-[896px] flex-wrap justify-center gap-x-10 gap-y-8 pb-4 pt-10 sm:gap-x-16 lg:justify-between lg:gap-x-20 xl:gap-[80px]">
        ...
        <div className="flex max-w-[168px] flex-col gap-[7px]">
          <p className="text-left text-[12px] font-bold uppercase tracking-[2px] text-[var(--text-primary)]">
            Team
          </p>
