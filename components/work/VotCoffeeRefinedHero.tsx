...
/** Figma 401:739 — Refined hero (badge, title, subtitle, photography, Role / Team / Timeline / Tools). */
export function VotCoffeeRefinedHero({ project }: { project: ProjectMeta }) {
  const imgSrc = project.heroImage || VOT_COFFEE_HERO_IMAGE;
