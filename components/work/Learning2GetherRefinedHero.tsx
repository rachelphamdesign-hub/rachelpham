...
import { Learning2GetherHeroVideo } from "@/components/work/Learning2GetherHeroVideo";

/** Hero — badge, title, tagline, video, Role / Team / Timeline / Tools. */
export function Learning2GetherRefinedHero({ project }: { project: ProjectMeta }) {
  const videoSrc = project.heroVideo ?? "/media/l2t_port/Scene%20copy.mp4";
  ...
  return (
    <div className="mx-auto max-w-[980px] px-6">
      ...
      <Learning2GetherHeroVideo videoSrc={videoSrc} />
